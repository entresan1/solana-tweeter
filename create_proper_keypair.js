...
// Generate a proper program keypair
...
const fs = require('fs');
fs.writeFileSync('program_keypair.json', JSON.stringify(Array.from(keypair)));

// Also create the program ID
const programId = require('bs58').encode(seed);
console.log('New Program ID:', programId);
console.log('Keypair created: program_keypair.json');
