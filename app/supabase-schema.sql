...
CREATE POLICY "Allow public insert access to beacons" ON beacons
...
CREATE POLICY "Allow public read access to beacon_likes" ON beacon_likes
  FOR SELECT USING (true);

CREATE POLICY "Allow public insert access to beacon_likes" ON beacon_likes
  FOR INSERT WITH CHECK (true);

CREATE POLICY "Allow public delete access to beacon_likes" ON beacon_likes
  FOR DELETE USING (true);

CREATE POLICY "Allow public read access to beacon_replies" ON beacon_replies
  FOR SELECT USING (true);

CREATE POLICY "Allow public insert access to beacon_replies" ON beacon_replies
  FOR INSERT WITH CHECK (true);
