...
<template>
  <div class="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-800 relative overflow-hidden">
    ...
    <div class="relative w-full max-w-6xl mx-auto">
      <!-- Sidebar -->
      <the-sidebar class="py-2 md:py-8 md:pl-4 md:pr-8 fixed w-16 md:w-64 z-10" />

      <!-- Main Content -->
      <main class="flex-1 ml-16 md:ml-64 min-h-screen">
        <!-- Clean Header -->
        <header class="glass border-b border-dark-700/50 backdrop-blur-xl">
          <div class="flex items-center justify-between px-4 md:px-8 py-4 md:py-6">
            ...
            <div class="flex items-center space-x-2 md:space-x-4">
              ...
              <div class="md:hidden flex items-center space-x-1 px-2 py-1 rounded-full bg-dark-800/50 border border-dark-600/50">
                <div class="w-1.5 h-1.5 bg-solana-500 rounded-full"></div>
                <span class="text-xs text-dark-300">SOL</span>
              </div>
              <!-- Status Indicator -->
