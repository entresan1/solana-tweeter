...
<template>
  <div v-if="connected" class="card mb-6 group relative overflow-hidden">
    ...
    <div class="relative z-10">
      ...
      <div v-if="isSubmitting" class="mt-3 p-3 bg-primary-500/10 border border-primary-500/30 rounded-lg text-center">
        <div class="flex items-center justify-center space-x-2">
          <svg class="w-4 h-4 animate-spin text-primary-400" fill="none" viewBox="0 0 24 24">
            <circle class="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" stroke-width="4"></circle>
            <path class="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <span class="text-primary-300 font-medium text-sm">Beacon is sending...</span>
        </div>
        <p class="text-primary-400/70 text-xs mt-1">Please wait while your beacon is being processed on the blockchain</p>
      </div>
