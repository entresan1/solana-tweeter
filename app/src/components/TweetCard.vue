  ...
  <div class="card hover-lift animate-slide-up">
    <div class="flex items-start space-x-4">
      ...
      <div class="flex-shrink-0">
        <div class="w-12 h-12 rounded-full bg-gradient-to-r from-accent-500 to-solana-500 flex items-center justify-center">
      ...
      <div class="flex-1 min-w-0">
        ...
        <div class="flex items-center space-x-2 mb-2">
          <h3 class="font-semibold text-white" :title="tweet?.author.toBase58()">
            <router-link :to="authorRoute" class="hover:text-accent-400 transition-colors duration-200">
        ...
        <router-link
          ...
          class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-gradient-to-r from-accent-500/20 to-solana-500/20 text-accent-400 hover:from-accent-500/30 hover:to-solana-500/30 transition-all duration-200 hover-lift"
        >
